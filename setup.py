"""
The setup file for packaging pak_bot
"""
...
def get_version():
    ...
    """
    v_line = None
    with open(os.path.join(ROOT, 'pak_bot', '__init__.py')) as fin:
        for line in fin:
...
def get_short_desc():
    """
    Fetch one line description from source code.
    """
    with open(os.path.join(ROOT, MODULE, '__init__.py')) as fin:
...
class ReleaseCommand(Command):
    ...
    def run(self):
        ...
        os.chdir(ROOT)
        self.copy_files_to(os.path.join(MODULE, 'extra'))
...
setup(
    ...
    url='https://github.com/pakit/pak_bot',
    author=MY_NAME,
    ...
    # package_data={
        # MODULE: ['extra/CHANGELOG', 'extra/DEMO.md', 'extra/LICENSE',
